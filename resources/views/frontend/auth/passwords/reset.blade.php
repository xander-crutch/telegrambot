					...
					<x-slot name="body">
						<x-forms.post :action="route('frontend.auth.password.update')">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="email" name="email" id="email" class="form-control" placeholder="{{ __('E-mail Address') }}" value="{{ $email ?? old('email') }}" maxlength="255"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="{{ __('Password Confirmation') }}" maxlength="100"
